...
\head{Profile}
  \begin{list}{}{\leftmargin=0em}
    \item Entrepreneurial financial technology professional with extensive knowledge
    of utilizing technology to streamline business processes in the fin-tech industry,
    including portfolio construction, risk management, algorithmic execution, and fund
    operations. Outstanding track record combined with professionalism, integrity, and
...
\head{Professional Experience} \\
  ...
  \end{tabular*}
    \begin{list}{\labelitemiv}{\leftmargin=0em}
      \item \textit{Portfolio \& Risk Management}: Developed systematic investment
        ...
        Statistical Inference / Machine Learning techniques to manage risk and
        exploit real-time changes in asset-class diversification potential.
      \item \textit{Research}: Custom built back- and stress-testing infrastructure
        as well as real-time visualization UI to research and improve proprietary
        trading strategies.
  ...
  \begin{list}{}{\leftmargin=0em}
    \item Three rotations in high profile, decision making positions in a
      broad selection of AT\&T's Finance/Strategy Organizations
  \end{list}
...
\head{Technical Skills}
  \begin{list}{\labelitemiv}{\leftmargin=0em}
    \item \textit{Programming}: Python, SQL (My, Postgre, Transact), Java, Scala, R, Shell Scripting, Visual Basic, \LaTeX
    ...
    \item \textit{Software}: Bloomberg (Terminal, AIM, TradeBook, EMSX, BPIPE \& SAPI),
      Microsoft Office, Git, Mathematica, MatLab
  \end{list}
\head{Personal}
  \begin{list}{\labelitemiv}{\leftmargin=0em}
