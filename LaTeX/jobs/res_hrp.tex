...
\head{Objective}
  \begin{list}{}{\leftmargin=0em}
    \item Seeking position as quantitative trader \& portfolio manager at Hedge Fund,
      Asset Manager, or Family Office.
  \end{list}
\head{Profile}
  \begin{list}{}{\leftmargin=0em}
    \item Accomplished financial technology professional \& portfolio manager
