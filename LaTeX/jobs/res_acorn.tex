...
\head{Objective}
  \begin{list}{}{\leftmargin=0em}
    \item Seeking position in risk management and/or
      portfolio construction at a disruptive financial technology firm.
  \end{list}
\head{Profile}
  \begin{list}{}{\leftmargin=0em}
    \item Accomplished financial technology professional with over 10 years of
    quantitative buy-side experience. Extensive knowledge of portfolio
    construction, risk management, algorithmic trading, quantitative research,
    and fund operations. Outstanding performance track record combined with
...
\head{Professional Experience} \\
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
    \textbf{\large Pacific Rim Capital Management}, Irvine, CA & \textbf{January 2018 -- Current} \\
    \hline
  \end{tabular*} \\
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
    \textbf{Portfolio Manager - Structured Alpha}
  \end{tabular*}
  \begin{list}{}{\leftmargin=0em}
    \item Developing systematic investment process for liquid Equity, ETF, and
    Derivative trading platform utilizing risk-based quantitative techniques and
    Machine Learning to manage and exploit real-time changes in portfolio
    risk relationships.
  \end{list}
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
  ...
  \end{tabular*} \\
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
    \textbf{Director - Portfolio \& Risk Management} & \textbf{January 2012 -- October 2017}
  \end{tabular*}
    \begin{list}{\labelitemiv}{\leftmargin=1em}
      ...
      \item \textit{Research}: Implemented ``tactical risk budgeting" paradigm
    ...
    \begin{list}{\labelitemiv}{\leftmargin=1em}
     ...
     %  for maximum return per unit of risk.
      ...
      \item \textit{Operations}: Assisted back-office team and several
        business partners to reconcile trades and fairly allocate profits/losses.
  ...
  \end{tabular*}
  \begin{list}{}{\leftmargin=0em}
    \item Three rotations in high profile positions in
      AT\&T's Finance Organization: Global Strategy, Investor Relations, Treasury
  \end{list}
...
\head{Technical Skills}
  \begin{list}{\labelitemiv}{\leftmargin=1em}
    \item \textit{Programming}: Python, SQL (My, Postgre, MS; Tableau), Java, Scala, R, Shell Scripting, Visual Basic, \LaTeX
    \item \textit{Operating Systems}: Debian \& Red Hat Linux, Windows, Macintosh, Ubuntu
    \item \textit{Software}: Bloomberg (Terminal, AIM, EMSX, TradeBook, BPIPE \& SAPI),
      Microsoft Office, Git, SVN, Mathematica
  \end{list}
\head{Personal}
  \begin{list}{\labelitemiv}{\leftmargin=1em}
