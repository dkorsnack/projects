...
\head{Objective}
  \begin{list}{}{\leftmargin=0em}
    \item Seeking position as quantitative trader / software developer (in front
      or middle office) at leading global investment firm.
  \end{list}
\head{Profile}
  \begin{list}{}{\leftmargin=0em}
...
\head{Professional Experience} \\
  ...
  \end{tabular*}
    ...
    \end{list}
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
    \textbf{\large AT\&T}, Bedminster, NJ & \textbf{August 2005 -- Februrary 2008} \\
    \hline
  \end{tabular*} \\
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
