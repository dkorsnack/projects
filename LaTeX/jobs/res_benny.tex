...
\head{Objective}
  \begin{list}{}{\leftmargin=0em}
    \item Seeking position as quantitative trader / portfolio manager at Hedge Fund, Asset Manager,
      or Family Office.
  \end{list}
\head{Profile}
  \begin{list}{}{\leftmargin=0em}
    \item Accomplished portfolio manager, trader, \& financial technology professional
...
\head{Professional Experience} \\
  ...
  \end{tabular*}
    \begin{list}{\labelitemiv}{\leftmargin=1em}
      \item \textit{Business Development}: Raised assets from approximately \$20M in partner capital
        to \~\$350M from institutional investors. 
      \item \textit{Portfolio Management}: Optimized and continuously rebalanced
...
\head{Technical Skills}
  \begin{list}{\labelitemiv}{\leftmargin=1em}
    \item \textit{Programming}: Python, SQL, Shell Scripting, Visual Basic, XML, \LaTeX, R, Java, Scala
