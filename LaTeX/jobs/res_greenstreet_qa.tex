...
\head{Objective}
  \begin{list}{}{\leftmargin=0em}
    \item Seeking position in quantitative analysis / development at industry-leading research firm
  \end{list}
\head{Profile}
  \begin{list}{}{\leftmargin=0em}
    \item Accomplished financial technology professional with 10 years of
    buy-side experience and extensive knowledge of quantitative
    research, risk management, portfolio construction, algorithmic
    trading, and fund operations. Outstanding performance track record
    combined with professionalism, integrity, and the ability to work
