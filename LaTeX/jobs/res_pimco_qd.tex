...
\head{Objective}
  \begin{list}{}{\leftmargin=0em}
    \item Seeking position in quantitative modeling / software development 
      at a leading global ivestment firm. 
  \end{list}
\head{Profile}
  \begin{list}{}{\leftmargin=0em}
    \item Accomplished financial technology professional \& software developer
