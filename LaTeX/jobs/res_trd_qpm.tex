...
\head{Objective}
  \begin{list}{}{\leftmargin=0em}
    \item Seeking position as portfolio manager / quantitative trader at Hedge
      Fund, Asset Manager, or Family Office.
  \end{list}
\head{Profile}
  \begin{list}{}{\leftmargin=0em}
    \item Accomplished financial technology professional \& trader with 10 years
    of experience and extensive knowledge of portfolio construction, risk management,
    algorithmic trading, quantitative research, and fund operations. Outstanding
    performance track record combined with professionalism, integrity,
...
\head{Professional Experience} \\
  ...
  \end{tabular*}
    \begin{list}{\labelitemiv}{\leftmargin=1em}
      \item \textit{Portfolio Management}: Optimized and continuously rebalanced
        investor specific portfolios. Implemented dynamic hedging policy using
  ...
  \end{tabular*}
    ...
    \end{list}
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
    \textbf{\large AT\&T}, Bedminster, NJ & \textbf{March 2008 -- December 2011} \\
    \hline
  \end{tabular*} \\
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
