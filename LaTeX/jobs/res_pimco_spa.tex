...
\head{Objective}
  \begin{list}{}{\leftmargin=0em}
    \item Seeking position in quantitative portfolio management
      at a leading global investment firm. 
  \end{list}
\head{Profile}
  \begin{list}{}{\leftmargin=0em}
    \item Accomplished financial technology professional and systematic
    trader with 10 years of buy-side experience, extensive knowledge of portfolio construction,
...
\head{Professional Experience} \\
  ...
  \end{tabular*}
    \begin{list}{\labelitemiv}{\leftmargin=1em}
      ...
      \item \textit{Portfolio Management}: Continuously rebalanced investor specific,
        multi-asset portfolios (including Equity, Fixed Income, \& Alternatives).
        Implemented dynamic hedging policy using liquid Futures \& Options.
