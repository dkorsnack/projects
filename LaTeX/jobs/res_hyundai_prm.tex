...
\head{Profile}
  \begin{list}{}{\leftmargin=0em}
    ...
    executive with 12+ years of buy-side experience. Extensive knowledge
    working with large data sets to improve risk management, portfolio construction,
    algorithmic trading, and fund operations. Outstanding track record combined
    with professionalism, integrity, and the ability to lead and work cohesively with a team. 
  \end{list}
\head{Professional Experience} \\
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
    \textbf{\large Tee Investment Services LLC} $\vert$ Large Single Family Office $\vert$ Irvine, CA & \textbf{February 2018 -- Current} \\
    \hline
  \end{tabular*} \\
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
  ...
  \end{tabular*}
    \begin{list}{\labelitemiv}{\leftmargin=0em}
      ...
      \item \textit{Trading \& Operations}: Automated firm-wide trading via
        ...
        Orchestrated an SEC ``Mock Audit" after designing and implementing a
        multi-strategy, multi-SMA allocation algorithm to ensure all clients
        brokerage accounts trade in lock-step.
      \item \textit{Data Services}: Migrated from on-site data center to ``the
        ...
        impact on performance. Expanded into ``big-data" sets including tick level
        quotes and trades for Equities and Derivatives while enhancing data retrieval
        methods to increase efficiency, boosting speed 2-5x over previous capabilities.
  \end{list}
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
  ...
  \end{tabular*} \\
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
    \textbf{Partner \& Portfolio Manager - Risk, Trading \& Technology} & \textbf{January 2012 -- November 2017}
  \end{tabular*}
    \begin{list}{\labelitemiv}{\leftmargin=0em}
      ...
      \item \textit{Portfolio \& Risk Management}: Continuously rebalanced
        ...
        Derivative, \& Alternatives). Implemented dynamic hedging policy using
    ...
    \end{list} 
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
    \textbf{Associate - Risk, Trading \& Technology} $\vert$ Creation of \textbf{Potamus Trading LLC} & \textbf{March 2008 -- December 2011}
  \end{tabular*}
    \begin{list}{\labelitemiv}{\leftmargin=0em}
    ...
    \end{list}
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
    \textbf{\large AT\&T} $\vert$ Treasury, Corporate Finance, \& Strategy $\vert$ Bedminster, NJ & \textbf{August 2005 -- February 2008} \\
    \hline
  \end{tabular*} \\
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
...
\head{Education \& Certification} \\
  ...
  \begin{list}{\labelitemiv}{\leftmargin=0em}
   ...
   \item \textbf{CFA} (Chartered Financial Analyst) Level II Candidate
   \item \textbf{Series 3} (National Commodity Futures) Licensed \\ \\
  \end{list}
\head{Technical Skills}
  \begin{list}{\labelitemiv}{\leftmargin=0em}
    ...
    \item \textit{Operating Systems}: Debian, Red Hat \& AWS Linux, Windows, Macintosh, Ubuntu
    \item \textit{Software}: Bloomberg (Terminal, AIM, EMSX, BPIPE \& SAPI),
      Microsoft365/Office Power User, Factset, Geneva, Charles River 
  \end{list}
\head{Personal}
  \begin{list}{\labelitemiv}{\leftmargin=0em}
