...
\head{Professional Experience} \\
  ...
  \end{tabular*}
    \begin{list}{\labelitemiv}{\leftmargin=0em}
      \item \textit{Portfolio \& Risk Management}: Constructed Process Dependency Tree and
...
\head{Technical Skills}
  \begin{list}{\labelitemiv}{\leftmargin=0em}
    \item \textit{Programming}: Python, SQL (My, Postgre, Tramsact), Java, Scala, R, Shell Scripting, Visual Basic, \LaTeX
    ...
    \item \textit{Software}: Bloomberg (Terminal, AIM, EMSX, BPIPE \& SAPI),
      Microsoft Office, Git, FactSet, Mathematica, MatLab
  \end{list}
\head{Personal}
  \begin{list}{\labelitemiv}{\leftmargin=0em}
