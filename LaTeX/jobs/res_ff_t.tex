...
\head{Profile}
  \begin{list}{}{\leftmargin=0em}
    \item Entrepreneurial trader and financial technology professional with 12+ years of
    buy-side experience. Demonstrated ability to help clients meet their financial
    goals, adding value across the entire investment process. Outstanding 
    track record combined with professionalism, integrity and the ability to work
    cohesively within a team. 
  \end{list}
\head{Professional Experience} \\
  ...
  \end{tabular*} \\
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
    \textbf{Director -- Trading \& Technology}
  \end{tabular*}
    \begin{list}{\labelitemiv}{\leftmargin=0em}
      \item \textit{Trading \& Operations}: Automated firm-wide trading via
        ...
        leveraging Bloomberg EMSX \& API, cutting trading slippage in half. 
  ...
  \end{tabular*} \\
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
    \textbf{Director -- Trading \& Technology} & \textbf{January 2012 -- November 2017}
  \end{tabular*}
    \begin{list}{\labelitemiv}{\leftmargin=0em}
  ...
  \end{tabular*}
    \begin{list}{\labelitemiv}{\leftmargin=0em}
      \item \textit{Business Development}: Assisted in spin-out Potamus Trading LLC, a
          registered SEC Broker Dealer and DMM on the NYSE.
...
\head{Technical Skills}
  \begin{list}{\labelitemiv}{\leftmargin=0em}
    ...
    \item \textit{Software}: Bloomberg (Terminal, AIM, TradeBook, EMSX, BPIPE/SAPI),
      Microsoft Office/VBA, Git, Mathematica, MatLab
  \end{list}
\head{Personal}
  \begin{list}{\labelitemiv}{\leftmargin=0em}
