...
\head{Profile}
  \begin{list}{}{\leftmargin=0em}
    ...
    working with large data sets to improve portfolio construction, risk management,
...
\head{Professional Experience} \\
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
    \textbf{\large Tee Investment Services} $\vert$ Large Single Family Office $\vert$ Irvine, CA & \textbf{February 2018 -- Current} \\
    \hline
  \end{tabular*} \\
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
...
\head{Technical Skills}
  \begin{list}{\labelitemiv}{\leftmargin=0em}
    ...
    \item \textit{Operating Systems}: Debian \& Red Hat Linux, Windows (Microsoft 365 Power User), Macintosh, Ubuntu
    \item \textit{Software}: Bloomberg (Terminal, AIM, EMSX, BPIPE \& SAPI),
      Microsoft365 Power User, Factset, Geneva, Charles River 
  \end{list}
\head{Personal}
  \begin{list}{\labelitemiv}{\leftmargin=0em}
