...
\head{Objective}
  \begin{list}{}{\leftmargin=0em}
    \item Seeking position as quantitative trader / software developer at Hedge Fund, Asset Manager,
      or Family Office.
  \end{list}
\head{Profile}
  \begin{list}{}{\leftmargin=0em}
    \item Accomplished trader, software developer, \& financial technology professional
...
\head{Education \& Certification} \\
  ...
  \begin{list}{\labelitemiv}{\leftmargin=1em}
   ...
   \item \textbf{Series 3} Licensed
    \item \textbf{CFA} (Chartered Financial Analyst) Charterholder
  \end{list}
