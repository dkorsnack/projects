...
\head{Objective}
  \begin{list}{}{\leftmargin=0em}
    \item Seeking position in trading, risk management, and/or
      portfolio construction at a leading global investment firm.
  \end{list}
\head{Profile}
  \begin{list}{}{\leftmargin=0em}
    \item Accomplished quantitative, financial technology professional
    with over 10 years of buy-side experience and extensive knowledge of portfolio
...
\head{Professional Experience} \\
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
    \textbf{\large Pacific Rim Capital Management}, Irvine, CA & \textbf{Februrary 2018 -- Current} \\
    \hline
  \end{tabular*} \\
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
    \textbf{Consultant - Structured Alpha}
  \end{tabular*}
  \begin{list}{}{\leftmargin=0em}
    \item Assisting in the development of systematic investment process for liquid
    Options trading platform utilizing Machine Learning to better price derivative
    securities and exploit real-time changes in equity volatility.
  \end{list}
  \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
  ...
  \begin{list}{}{\leftmargin=0em}
    \item Three rotations in high profile positions in
      AT\&T's Finance Organization: Treasury, Investor Relations, Global Strategy
  \end{list}
